...
ALTER TABLE contrib_paths ADD CONSTRAINT ux_contrib_paths UNIQUE(lang, node_id_src, node_id_dst);
...
WHERE     n1.lang = p.lang AND n1.node_id = p.node_id_src AND
          n2.lang = p.lang AND n2.node_id = p.node_id_dst
;
